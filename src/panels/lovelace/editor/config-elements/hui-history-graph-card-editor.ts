...
import { Config, ConfigEntity } from "../../cards/hui-history-graph-card";
...
export class HuiHistoryGraphCardEditor extends hassLocalizeLitMixin(LitElement)
